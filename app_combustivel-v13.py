...
with tab_efet:
    ...
    with col_ef2:
        ...
        if not df_km_cost.empty:
            ...
            # Apply Cost Semaphore Colors (< 0.85 Green, 0.85 to 0.95 Amarelo #AFA05F, > 0.95 Red)
...
with tab_mot:
    ...
    with col_m1:
        ...
        fig_driver_spend = px.bar(
            ...
            color_discrete_sequence=['#009a53', '#AFA05F', '#dc2626'],
    ...
    with col_m2:
        ...
        if not df_drv_km_cost.empty:
            ...
            # Apply driver Semaphore Colors (same logic as trucks: < 0.85 Green, 0.85 to 0.95 Amarelo #AFA05F, > 0.95 Red)
