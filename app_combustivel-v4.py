...
with tab_oper:
    ...
    fig_fq_dual.update_layout(
        ...
        yaxis=dict(title=dict(text="Valor Gasto (R$)", font=dict(color="#0f172a")), tickfont=dict(color="#0f172a")),
        yaxis2=dict(title=dict(text="Volume (Litros)", font=dict(color="#3b82f6")), tickfont=dict(color="#3b82f6"), overlaying="y", side="right"),
